...
public class BlockModWallTorch extends WallTorchBlock {
    public BlockModWallTorch() { super(Settings.copy(Blocks.WALL_TORCH), ParticleTypes.FLAME); }
    public BlockModWallTorch(ParticleEffect particle) { super(Settings.copy(Blocks.WALL_TORCH), particle); }
