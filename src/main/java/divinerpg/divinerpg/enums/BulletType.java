...
//    private SimpleParticleType particle;
    ...
    //Generic bullets
    BulletType(float damage, Identifier texture) {
        this.damage = damage;
    ...
    BulletType(float damage, Identifier texture, BulletDamageType type) {
        this.damage = damage;
        this.texture = texture;
    ...
    BulletType(float damage, Identifier texture, DefaultParticleType particle, BulletDamageType type) {
        this.damage = damage;
        this.texture = texture;
    ...
    BulletType(float damage, Identifier texture, BulletDamageType type, BulletSpecial special, int power, int sec) {
        this.damage = damage;
        this.texture = texture;
        bulletDamageType = type;
    ...
    BulletType(float damage, Identifier texture, BulletDamageType type, BulletSpecial special) {
        this.damage = damage;
        this.texture = texture;
        bulletDamageType = type;
        bulletSpecial = special;
    ...
    BulletType(float damage, Identifier texture, DefaultParticleType particle, BulletSpecial special) {
        this.damage = damage;
        this.texture = texture;
        this.particle = particle;
    ...
    //Split projectiles
    BulletType(float damage, Identifier texture, DefaultParticleType particle, BulletType type, int amount) {
        this.damage = damage;
        this.texture = texture;
        this.particle = particle;
        bulletDamageType = BulletDamageType.ARCANA;
    ...
    private static Identifier blank() {return new Identifier("minecraft:textures/particle/generic_0.png");}
    public static Identifier ItemLoc(String name) {return new Identifier(MOD_ID, "textures/item/" + name + ".png");}
    private static Identifier VanillaItemLoc(String name) {return new Identifier("minecraft:textures/item/" + name + ".png");}
    public float getDamage() {return damage;}
    public Identifier getTexture() {return texture;}
    public DefaultParticleType getParticle() {return particle;}
