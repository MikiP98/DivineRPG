...
//        SNOWFLAKES_MUSIC = Musics.createGameMusic(SNOWFLAKES_AFTER_BLIZZARD);
    ...
    private static SoundEvent registerSound(String registryName) {
        Identifier id = getId(registryName);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

//    private static JukeboxSong registerSong(String name, SoundEvent sound, float lengthInSeconds, int comparatorOutput) {
//        return SONGS.register(name, () -> new JukeboxSong(sound, Component.translatable(Util.makeDescriptionId("jukebox_song", getId(name))), lengthInSeconds, comparatorOutput));
//    }
}